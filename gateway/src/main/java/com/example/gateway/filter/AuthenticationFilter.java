...
public class AuthenticationFilter extends AbstractGatewayFilterFactory<AuthenticationFilter.Config> {
    ...
    public AuthenticationFilter(JwtUtils jwtUtil, RestTemplate restTemplate, RouteValidator validator,Carousel carousel) {
        super(Config.class);
            ...
            if (validator.isSecure.test(exchange.getRequest())) {
                ...
                try {
                    if (activeProfile.equals("test")){
                        log.debug("init auth methods for tests");
                    ...
                    log.warn("Login failed, bad token");
